...
export default function Socios() {
  return (
    <section id="socios" className="secao fio-topo">
      <div className="wrap">
        <Revelar>
          <p className="sobrancelha"><b>06</b>Quem atende</p>
          <h2 className="titulo-secao mt-6 max-w-4xl">
            Dois sócios. Nenhuma camada
            <br />
            entre você e o <span className="enfase-clara">código</span>.
          </h2>
              ...
              <div className="cartao h-full p-7 md:p-9">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-[0.8125rem] text-[#656c7d]">{s.papel}</p>
                  </div>
                </div>
                <p className="mt-6 text-sm leading-relaxed text-[#9aa1b2]">{s.texto}</p>
