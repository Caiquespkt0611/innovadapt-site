...
export default function Diferenca() {
  return (
    <section id="diferenca" className="secao border-t border-white/[0.06] bg-[#080b13]">
      <div className="wrap">
        <Revelar>
          ...
          <h2 className="titulo-secao mt-6 max-w-4xl">
            ...
            <br />
            <span className="text-[#98a4bb]">Está faltando sistema que age.</span>
          </h2>
            ...
            <table className="w-full border-collapse text-left">
              <thead>
                <tr className="bg-white/[0.03]">
                  <th className="w-[24%] px-6 py-5 text-xs font-semibold uppercase tracking-[0.14em] text-[#5f6c85]">
                    Critério
                  </th>
                  <th className="w-[38%] border-l border-white/[0.06] px-6 py-5 text-sm font-semibold text-[#98a4bb]">
                    {comparativo.colunas[0]}
                  </th>
                  <th className="w-[38%] border-l border-[#00b4ff]/25 bg-[#00b4ff]/[0.045] px-6 py-5 text-sm font-semibold text-white">
              ...
              <tbody>
                {comparativo.linhas.map((linha) => (
                  <tr key={linha.criterio} className="border-t border-white/[0.06]">
                    ...
                    <td className="border-l border-white/[0.06] px-6 py-5 align-top text-sm leading-relaxed text-[#5f6c85]">
                      {linha.deles}
                    </td>
                    <td className="border-l border-[#00b4ff]/25 bg-[#00b4ff]/[0.045] px-6 py-5 align-top text-sm leading-relaxed text-[#e6edfa]">
                      {linha.nosso}
                    </td>
                  </tr>
                ))}
          ...
          {comparativo.linhas.map((linha, i) => (
            <Revelar key={linha.criterio} delay={i * 40}>
              <div className="cartao p-5">
                ...
                <p className="mt-3 text-[0.8125rem] leading-relaxed text-[#5f6c85]">
                  <span className="mono mr-2 text-[0.6875rem] uppercase tracking-wider">
                    prateleira
                  </span>
                  {linha.deles}
                </p>
                <p className="mt-2 border-l-2 border-[#00b4ff] pl-3 text-[0.8125rem] leading-relaxed text-[#e6edfa]">
                  <span className="mono mr-2 text-[0.6875rem] uppercase tracking-wider text-[#00b4ff]">
                    innovadapt
                  </span>
                  {linha.nosso}
                </p>
        ...
        <Revelar delay={120}>
          <p className="mt-10 text-sm text-[#5f6c85]">
